...
const TermsAndConditions = () => (
  <Container>
    <Heading>Welcome to Mixtape Madness</Heading>
    <Content>
    ...
    <Headingh3>Cookies</Headingh3>
    <Content>
      We employ the use of cookies. By using Mixtape Madness's website you
      consent to the use of cookies in accordance with Mixtape Madness’s privacy
      policy.Most of the modern day interactive web sites use cookies to enable
      us to retrieve user details for each visit. Cookies are used in some areas
      of our site to enable the functionality of this area and ease of use for
      those people visiting. Some of our affiliate / advertising partners may
      also use cookies.
    </Content>

    <Headingh3>License</Headingh3>
    <Content>
      Unless otherwise stated, Mixtape Madness and/or it’s licensors own the
      intellectual property rights for all material on Mixtape Madness. All
      intellectual property rights are reserved. You may view and/or print pages
      from http://www.mixtapemadness.com for your own personal use subject to
      restrictions set in these terms and conditions.
    </Content>

    <Headingh3>You must not:</Headingh3>

    <Content>Republish material from http://www.mixtapemadness.com</Content>
    <Content>
      Sell, rent or sub-license material from http://www.mixtapemadness.com
    </Content>
    <Content>
      Reproduce, duplicate or copy material from http://www.mixtapemadness.com
    </Content>
    <Content>
      Redistribute content from Mixtape Madness (unless content is specifically
      made for redistribution).
    </Content>
    <Content>Hyperlinking to our Content</Content>

    <Headingh3>
      The following organizations may link to our Web site without prior written
      approval:
    </Headingh3>
    <Content>Government agencies;</Content>
    <Content>Search engines;</Content>
    <Content>News organizations;</Content>
    <Content>
      Online directory distributors when they list us in the directory may link
      to our Web site in the same manner as they hyperlink to the Web sites of
      other listed businesses; and Systemwide Accredited Businesses except
    ...
    <Headingh3>
      ...
      Chambers of Commerce, American Automobile Association, AARP and Consumers
      Union;
    </Headingh3>
    <Content>dot.com community sites;</Content>
    <Content>
      associations or other groups representing charities, including charity
      giving sites, online directory distributors;
    </Content>
    <Content>internet portals;</Content>
    <Content>
      accounting, law and consulting firms whose primary clients are businesses;
    </Content>
    <Content>and educational institutions and trade associations.</Content>
    ...
    <Content>
      ...
      not have an unsatisfactory record with us; (c) the benefit to us from the
      visibility associated with the hyperlink outweighs the absence of ; and
    ...
    <Content>
      ...
      e-mail to Admin@MixtapeMadness.com Please include your name, your
      ...
      which you intend to link to our Web site, and a list of the URL(s) on our
    ...
    <Content>
      ...
      (Web address) being linked to; or By use of any other description of our
      Web site or material being linked to that makes sense within the context
      and format of content on the linking party's site. No use of Mixtape
      Madness’s logo or other artwork will be allowed for linking absent a
      trademark license agreement.
    </Content>
    <Headingh3>Iframes</Headingh3>
    <Content>
    ...
    <Headingh3>Reservation of Rights</Headingh3>
    <Content>
    ...
    <Headingh3>Removal of links from our website</Headingh3>
    <Content>
    ...
    <Headingh3>Content Liability</Headingh3>
    <Content>
    ...
    <Headingh3>Disclaimer</Headingh3>
    <Content>
    ...
    <Content>
      or exclude any of our or your liabilities that may not be excluded under
      applicable law.
    </Content>
    ...
    <Content>(a) are subject to the preceding paragraph;</Content>
    <Content>
      (b) govern all liabilities arising under the disclaimer or in relation to
      the subject matter of this disclaimer, including liabilities arising in
